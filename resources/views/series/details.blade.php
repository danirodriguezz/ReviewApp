...
@section('content')
    <div>
        ...
        <div class="relative w-full h-[400px] bg-cover bg-center rounded-3xl" 
             style="background-image: url('{{ config('constants.image_banner_original') . $serie->banner_path }}');">
            ...
            <div class="absolute -bottom-10 left-14 bg-gray-800/80 rounded-xl px-8 py-12">
                <h1 class="text-3xl font-semibold text-white">{{$serie->titulo}}</h1>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 py-10">
            ...
            <div class="md:col-span-1">
                <img src="{{ config('constants.image_base_500_url') . $serie->imagen_path }}" alt="{{$serie->titulo}} Poster" 
            ...
            <div class="md:col-span-2 space-y-4">
                ...
                <p class="text-gray-300 leading-relaxed">{{$serie->descripción}}</p>
                ...
                <div class="w-20 bg-black/40 backdrop-blur-2xl  text-yellow-400 font-normal px-3 py-1 rounded-full flex items-center space-x-1">
                    ...
                    <span class="mt-1">{{ round($serie->puntuacion, 1) }}</span>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-200 mt-2">
                        {{ $serie->tipo === 'pelicula' ? 'Movie' : ($serie->tipo === 'serie' ? 'Serie' : 'Unknown') }}
                    </p>
                </div>
