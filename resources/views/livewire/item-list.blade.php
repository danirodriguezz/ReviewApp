    ...
    <div class="mt-10">
        ...
        <div class="mt-4">
            ...
            <div class="max-w-xs backdrop-blur-xl bg-blue-950/30 shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="relative">
                  <img class="w-full h-60 object-cover" src="URL_DE_LA_IMAGEN" alt="Portada de la película">
                  ...
                  <div class="absolute top-2 left-2 bg-black/60 backdrop-blur-2xl  text-yellow-400 font-normal px-3 py-1 rounded-full flex items-center space-x-1">
                    ...
                    <span class="mt-1">8.5</span>
                  </div>
                </div>
                
                <!-- Título de la película -->
                <div class="p-4">
                  <h2 class="text-lg font-bold text-white">Título de la película</h2>
                </div>
            </div>
