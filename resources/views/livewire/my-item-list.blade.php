<div>
    <div class="w-full flex justify-center sm:block">
        <div class="w-full flex justify-around space-x-4 backdrop-blur-xl p-3 rounded-lg bg-blue-950/30 mt-10 sm:mt-20">
            <button class="px-7 py-7 rounded bg-indigo-600 text-white font-semibold">
                Vistas <span class="text-sm">(50)</span>
            </button>
            <button class="px-4 py-2 rounded hover:bg-indigo-600 text-gray-400">
                Quiero ver <span class="text-sm">(24)</span>
            </button>
            <button class="px-4 py-2 rounded hover:bg-indigo-600 text-gray-400">
                Recomendaciones
            </button>
    ...
    <div class="mt-10">
        <h2 class="text-xl text-gray-400 font-bold">Todas<span class="text-sm">(1)</span></h2>
        <div class="mt-4 flex justify-center">
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              <div class="max-w-xs backdrop-blur-xl bg-blue-950/30 shadow-lg rounded-lg overflow-hidden">
                  <!-- Imagen -->
                  <div class="relative">
                    <img loading="lazy" class="w-full h-70 object-cover" src="{{ config('constants.image_base_300_url') . '/oiqKEhEfxl9knzWXvWecJKN3aj6.jpg' }}" alt="Portada de la película">
                  ...
                  <!-- Título  -->
                  <div class="p-4">
                    <a href="#" class="text-lg font-bold text-white cursor-pointer">Titulo de la pelicula</a>
                  </div>
              </div>
              {{-- Fin de la card  --}}
          </div>
